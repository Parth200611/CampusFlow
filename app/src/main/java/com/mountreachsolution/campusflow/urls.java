...
public class urls {
    ...
    public static String address="http://192.168.1.2:80/campusflow/";
    ...
    public static String addarc=address+"addarc.php";
    public static String addcast=address+"addcast.php";
